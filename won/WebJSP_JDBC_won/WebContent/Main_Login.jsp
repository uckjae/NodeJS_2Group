...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        <form action="Main_Login_ok.jsp" method="post" name="loginok">
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="password" id="pwd" class="form-control" placeholder="Password" name ="pwd" required="required">
        ...
        <div class="text-center">
          <a class="d-block small mt-3" href="Main_register.jsp">Register an Account</a>
